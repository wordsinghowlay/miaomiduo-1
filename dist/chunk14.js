...
const components = {
    headnav: __WEBPACK_IMPORTED_MODULE_1__common_header_vue___default.a, loading: __WEBPACK_IMPORTED_MODULE_2__common_loading_vue___default.a
};
...
// module
exports.push([module.i, ".select-area .cityRec{padding-left:.18rem}.select-area .cityList dl{text-align:left}.select-area .cityList dl dt{padding:0 .18rem;height:.75rem;line-height:.75rem;font-size:.22rem;color:#666;border-bottom:1px solid #ccc}.select-area .cityList dl dd{background:#fff;line-height:.75rem;padding:0 .18rem}.select-area .cityList dl dd p{border-bottom:1px solid #ccc;font-size:.24rem}.select-area .cityRec h3{font-size:.28rem;line-height:.6rem;text-align:left}.select-area .cityRec li{float:left;width:2.1rem;height:.74rem;border:1px solid #ccc;border-radius:.04rem;background:#fff;text-align:center;line-height:.74rem;margin:0 .18rem .18rem 0;font-size:.28rem;color:#333;overflow:hidden}.select-area .areaScroll{position:fixed;right:0;top:2.4rem;color:#a5d7ee;font-size:.28rem;line-height:1.2;padding:0 .16rem;text-align:center}", ""]);
...
module.exports={render:function (){var _vm=this;
  return _vm._c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.positionData.city != null),
      expression: "positionData.city != null"
    }],
    staticClass: "cr locate"
  }, [_vm._c('h3', [_vm._v("定位城市")]), _vm._v(" "), _vm._c('ul', {
    staticClass: "clearfix"
  }, [_vm._c('li', [_vm._v(_vm._s(_vm.positionData.city))])])]), _vm._v(" "), _vm._m(0), _vm._v(" "), _vm._c('div', {
    staticClass: "hotCity cr"
  }, [_vm._c('h3', [_vm._v("热门城市")]), _vm._v(" "), _vm._c('ul', {
    staticClass: "clearfix"
  }, _vm._l((_vm.hotCity), function(data) {
    return _vm._c('li', {
      on: {
  ...
  }, _vm._l((_vm.areaList), function(data) {
    return _vm._c('dl', [_vm._c('dt', {
      attrs: {
        "id": data.indexName
      }
    }, [_vm._v(_vm._s(data.indexName))]), _vm._v(" "), _vm._l((data.content), function(d) {
      return _vm._c('dd', {
        on: {
          "click": function($event) {
            _vm.switchArea(d)
    ...
    staticClass: "areaScroll"
  }, [_vm._c('ul', _vm._l((_vm.areaList), function(data) {
    return _vm._c('li', {
      on: {
        "click": function($event) {
          _vm.showNum(data.indexName)
        }
      }
    }, [_vm._v(_vm._s(data.indexName))])
  }))])], 1)
},staticRenderFns: [function (){var _vm=this;
  return _vm._c('div', {
    staticClass: "cr lastVisit"
  }, [_vm._c('h3', [_vm._v("最近访问的城市")]), _vm._v(" "), _vm._c('ul', {
    staticClass: "clearfix"
  }, [_vm._c('li', [_vm._v("上海市")])])])
}]}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-6e72703e!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./select-area.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-6e72703e!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./select-area.vue");
...
//# sourceMappingURL=chunk14.js.map?c1f9e64186bdb8820d0c