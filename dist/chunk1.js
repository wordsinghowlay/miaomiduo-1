...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__detail_html_vue__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__detail_html_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__detail_html_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_layer_vue__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_layer_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__common_layer_vue__);
//
//
//
//
...
// module
exports.push([module.i, ".dHtml{padding:0 .18rem;background:#fff;margin-top:.18rem;font-size:.24rem}.dHtml h3{line-height:.72rem;height:.72rem;font-size:.26rem;color:#666;border-bottom:1px solid #eee}.dHtml .dCon{padding:.18rem 0;line-height:1.5}.dHtml .dCon img{width:100%;height:auto}", ""]);
...
// module
exports.push([module.i, ".goodsDetail .proName{padding:.3rem .18rem;font-size:.26rem;line-height:1.5;background:#fff;color:#333}#pt{padding:0 .18rem .18rem;background:#fff;position:relative}#pt .price{font-size:.44rem;color:#ff2772;height:.6rem;line-height:.6rem}#pt .price span{padding:.03rem .06rem;border-radius:.06rem;color:#fff;font-size:.24rem;margin-left:.24rem;background-color:#ff833e;vertical-align:middle}#pt .pcon{padding-top:.12rem}#pt .pcon span{color:#666;font-size:.26rem}#pt .pcon .oldprice{width:3rem;float:left}#pt del{font-size:.26rem;color:#999}#pt .freight{width:3rem;float:left}#pt .sales{float:right}.proActInfo{padding:0 .18rem;margin:.18rem 0;background:#fff;height:.72rem;line-height:.72rem;font-size:.26rem;color:#666}#fuli span{font-size:.26rem;padding:.06rem .12rem;border:1px solid #fff;border-radius:.06rem}#fuli .mby{border-color:#ff2772;color:#ff2772}#fuli .ico{border-color:#ff833e;background:#ff833e;color:#fff}.bottomBar{position:fixed;bottom:0;left:0;width:100%;height:.9rem;z-index:5;background-color:#fff;border-top:1px solid #ddd}.bottomBar a{display:block;height:.7rem;padding:.1rem 0;text-align:center;float:left}.bottomBar-left,.bottomBar-right{float:left;width:50%}.bottomBar-left a{width:33.33%;padding:.15rem 0 .05rem;line-height:.35rem;color:#999;font-size:.24rem}.bottomBar-left .iconfont{font-size:.4rem;display:inline}.bottomBar .icon-favorfill{color:#fb0081}.bottomBar-right a{width:50%;line-height:.7rem;font-size:.3rem}.bottomBar-right .addToCart{background:#f57c33;color:#fff}.bottomBar-right .buyNow{background:#eb2258;color:#fff}.bottomBar-right .disabled{background:#999;color:#fff;width:100%}.buyPop{position:fixed;z-index:11;width:7.1rem;padding:0 .2rem .84rem;background:#fff;left:0;bottom:0}.buyPop .closePop{display:block;width:.32rem;height:.32rem;position:absolute;right:.18rem;top:.36rem;font-size:.32rem;color:#666;border:none;text-decoration:none}.buyPop .pro{border-bottom:1px solid #eee}.buyPop .sImg{width:2.1rem;height:2.1rem;position:relative;top:-.36rem;border:1px solid #cdcdcd;border-radius:.06rem;overflow:hidden}.buyPop .proN{position:absolute;left:2.6rem;top:.36rem;width:3.8rem;line-height:.36rem;font-size:.26rem;color:#000}.buyPop .pickWay{padding-bottom:.24rem;border-bottom:1px solid #eee}.buyPop .pickWay h3{height:.66rem;line-height:.66rem;font-size:.25rem;color:#666;font-weight:400}.buyPop .pickWay li{float:left;margin:0 .36rem 0 0;width:1.2rem;height:.5rem;text-align:center;line-height:.5rem;border:1px solid #ddd;color:#000;font-size:.25rem}.buyPop .pickWay li.cur{color:#ff2772;border-color:#ff2772}.buyPop .buyNum{height:.54rem;line-height:.54rem;padding:.3rem 0;border-bottom:1px solid #eee}.buyPop .buyNum .fl{font-size:.25rem;color:#666}.buyPop .buyNum .fr a{display:block;width:.6rem;height:.54rem;float:left;text-align:center;line-height:.54rem;background:#eee}.buyPop .buyNum .fr a i{font-size:.25rem;color:#000;display:block}.buyPop .buyNum .fr input{display:block;float:left;margin:0 .036rem;width:.66rem;height:.54rem;text-align:center;line-height:.54rem;background:#eee;border:none;color:#000;font-size:.32rem}.buyPop .qrjr{width:100%;display:inline-block;background-color:#eb2258;color:#fff;text-align:center;height:.72rem;line-height:.72rem;font-size:.3rem;border-radius:.06rem}", ""]);
...
module.exports={render:function (){var _vm=this;
  return _vm._c('div', {
    staticClass: "dHtml"
  }, [_vm._c('h3', [_vm._v("图文详情")]), _vm._v(" "), _vm._c('div', {
    staticClass: "dCon",
    domProps: {
      "innerHTML": _vm._s(_vm.removeStyle(_vm.detailHtml))
    }
  })])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;
  return _vm._c('div', {
    ...
    staticClass: "proName"
  }, [_vm._v(_vm._s(_vm.proName))]), _vm._v(" "), _vm._c('div', {
    ...
    staticClass: "price"
  }, [_vm._v("¥" + _vm._s(_vm.proTotal)), _vm._c('span', [_vm._v("可抵用" + _vm._s(_vm.proVouchers) + "优券")])]), _vm._v(" "), _vm._c('p', {
    staticClass: "pcon"
  }, [_vm._c('span', {
    staticClass: "oldprice"
  }, [_vm._v("价格："), _vm._c('del', [_vm._v(_vm._s(_vm.oldPrice))])]), _vm._v(" "), _vm._c('span', {
    staticClass: "freight"
  }, [_vm._c('em', [_vm._v(_vm._s(_vm.feight))])]), _vm._v(" "), _vm._c('span', {
    staticClass: "sales"
  }, [_vm._v("已售"), _vm._c('em', [_vm._v(_vm._s(_vm.soldNum))])])])]), _vm._v(" "), _vm._c('detailHtml'), _vm._v(" "), _vm._c('div', {
    staticClass: "bottomBar clearfix"
  }, [_vm._c('div', {
    staticClass: "bottomBar-left"
  }, [_vm._c('a', {
    attrs: {
      "href": _vm.tel
    }
  ...
  }), _vm._c('br'), _vm._c('span', [_vm._v("电话")])]), _vm._v(" "), _vm._c('a', {
    on: {
    ...
    class: [_vm.proCollect == 1 ? 'icon-favorfill' : 'icon-favor']
  }), _vm._c('br'), _vm._c('span', [_vm._v("收藏")])]), _vm._v(" "), _vm._c('router-link', {
    attrs: {
      "to": "/shopCart"
    }
  }, [_vm._c('i', {
    staticClass: "iconfont icon-gouwuche"
  }), _vm._c('br'), _vm._c('span', [_vm._v("购物车")])])], 1), _vm._v(" "), _vm._c('div', {
    staticClass: "bottomBar-right"
  }, [(!_vm.disabled && _vm.addToCart) ? _vm._c('a', {
  ...
  }, [_vm._v("加入购物车")]) : _vm._e(), _vm._v(" "), (!_vm.disabled) ? _vm._c('a', {
    staticClass: "buyNow",
    on: {
      "click": function($event) {
        _vm.showBuyPop('spro')
  ...
  }, [_vm._v("立即购买")]) : _vm._e(), _vm._v(" "), (_vm.disabled) ? _vm._c('a', {
    staticClass: "disabled"
  }, [_vm._v("已下架")]) : _vm._e()])]), _vm._v(" "), (_vm.showPop) ? _vm._c('div', {
    staticClass: "buyPop"
  }, [_vm._c('s', {
    staticClass: "closePop iconfont icon-roundclose",
    on: {
      "click": function($event) {
        _vm.showBuyPop()
      }
    ...
    attrs: {
      "src": _vm._f("imgFilter")(_vm.proThumImg, 2)
    }
  })]), _vm._v(" "), _vm._c('div', {
    staticClass: "proN"
  }, [_vm._v(_vm._s(_vm.proName))])]), _vm._v(" "), (false) ? _vm._c('div', {
    staticClass: "pickWay"
  }, [_vm._c('h3', [_vm._v("提货方式")]), _vm._v(" "), _vm._c('ul', {
  ...
  }, [_vm._v("送货上门")])])]) : _vm._e(), _vm._v(" "), _vm._c('div', {
    staticClass: "buyNum clearfix"
  }, [_vm._c('div', {
    staticClass: "fl"
  }, [_vm._v("\n                购买数量\n            ")]), _vm._v(" "), _vm._c('div', {
    staticClass: "fr"
  ...
  }, [_vm._v("确认")])]) : _vm._e(), _vm._v(" "), (_vm.showPop) ? _vm._c('layer', {
    nativeOn: {
      "click": function($event) {
        _vm.showBuyPop()
      }
    }
  }) : _vm._e(), _vm._v(" "), _vm._c('back-top', {
    attrs: {
      "show": true
    }
  })], 1)
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-41824336!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./detail-html.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-41824336!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./detail-html.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-63442ba9!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./goods-detail.vue", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-63442ba9!./../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./goods-detail.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
//# sourceMappingURL=chunk1.js.map?b2713d57eb8724bd8091